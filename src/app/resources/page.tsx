  ...
  if (loading) {
    return (
      <div className="min-h-screen gradient-bg flex items-center justify-center">
        <div className="w-8 h-8 animate-spin rounded-full border-4 border-[#2563eb] border-t-transparent" />
      </div>
    )
  }
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-12">
            ...
            <button
              ...
              className="w-full sm:w-auto group bg-[#111827] border-2 border-white/20 rounded-xl p-6 hover:border-[#2563eb] hover:bg-[#1a1f2e] transition-all"
            >
              <div className="flex items-center justify-between gap-4">
                <span className="text-base sm:text-lg text-white group-hover:text-[#2563eb] transition-colors">
                  The best website to make your resume for free in less than 30mns
                </span>
                <ExternalLink className="w-5 h-5 text-[#6b7280] group-hover:text-[#2563eb] transition-colors flex-shrink-0" />
              </div>
            </button>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <button
                ...
                className="group bg-[#111827] border border-[#1f2937] rounded-xl p-6 hover:border-[#2563eb] hover:bg-[#1a1f2e] transition-all text-left"
              >
                <Mail className="w-8 h-8 text-[#2563eb] mb-3" />
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <button
                ...
                className="group bg-[#111827] border border-[#1f2937] rounded-xl p-6 hover:border-[#2563eb] hover:bg-[#1a1f2e] transition-all text-left"
              >
                <BookMarked className="w-8 h-8 text-[#2563eb] mb-3" />
                <h3 className="text-base font-semibold text-white group-hover:text-[#2563eb] transition-colors mb-2">
                  A practical guide to quantitative finance interviews
                </h3>
                <ExternalLink className="w-4 h-4 text-[#6b7280] group-hover:text-[#2563eb] transition-colors" />
              </button>
                    ...
                    <ul className="space-y-3 text-[#9ca3af]">
                      <li className="flex items-start gap-2">
                        ...
                        <a 
                          ...
                          className="text-[#2563eb] hover:text-[#fb923c] underline transition-colors flex items-center gap-1"
                        >
              ...
              {activePopup === 'message' && (
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-[#1a1f2e] border border-[#1f2937] rounded-lg p-6">
                      <h5 className="font-semibold text-[#2563eb] mb-3">Template 1: Alumni Approach (Same School)</h5>
                    ...
                    <div className="bg-[#1a1f2e] border border-[#1f2937] rounded-lg p-6">
                      <h5 className="font-semibold text-[#2563eb] mb-3">Template 2: Non-Alumni, Personalized Hook</h5>
                ...
                <div className="space-y-4">
                  <div className="bg-[#1a1f2e] border border-[#1f2937] rounded-lg p-6">
                    ...
                    <div className="space-y-4 text-[#9ca3af]">
                      ...
                      <div className="mt-6 bg-[#0f172a] border border-[#2563eb]/20 rounded-lg p-4">
