...
function MissedQuestionCard({ 
  ...
  const color = categoryColors[section] || '#2563eb'
      ...
      {expanded && (
        <div className="px-4 sm:px-5 pb-4 sm:pb-5 border-t border-[#1f2937] pt-3 sm:pt-4 fade-in">
          <div className="bg-[#0a0f1a] rounded-xl p-3 sm:p-4 mb-3 sm:mb-4">
            <h4 className="text-xs sm:text-sm font-semibold text-[#2563eb] mb-2">Correct Answer:</h4>
            ...
            <div className="flex items-center gap-2 flex-wrap w-full sm:w-auto">
              {!question.reviewed && (
                <button
                  ...
                  className="flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm text-[#2563eb] hover:text-[#ea580c] transition-colors px-2 py-1.5 rounded-lg hover:bg-[#2563eb]/10"
                >
      ...
      <main className="pt-20 sm:pt-24 pb-12 px-3 sm:px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-[#111827] border border-[#1f2937] rounded-xl p-3 sm:p-4 mb-4 sm:mb-6 space-y-3 sm:space-y-4 overflow-x-hidden">
            {/* Filter Bar with All button and toggle buttons */}
            <div className="flex flex-wrap items-center gap-2 sm:gap-3">
              <span className="text-xs sm:text-sm text-[#9ca3af] whitespace-nowrap flex-shrink-0">Filter:</span>
              <button
                onClick={() => {
          ...
          {missedQuestions.length > 0 && (
            <div className="mt-6 sm:mt-8 grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4">
              ...
              <div className="bg-[#111827] border border-[#1f2937] rounded-lg sm:rounded-xl p-3 sm:p-4 text-center">
                <div className="text-xl sm:text-2xl font-bold" style={{ color: categoryColors[filterCategory as Category] || '#2563eb' }}>
