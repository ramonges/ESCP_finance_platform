      ...
      >
        ...
        <div className="bg-[#0a0f1a] rounded-lg sm:rounded-xl p-4 sm:p-6 mb-4 sm:mb-8">
          <div className="text-center">
            <div className="text-4xl sm:text-5xl font-bold mb-1 sm:mb-2" style={{ color: '#2563eb' }}>
              {overallPercentage}%
            </div>
        ...
        <div className="mt-6 sm:mt-8 grid grid-cols-3 gap-2 sm:gap-4">
          <div className="bg-[#0a0f1a] rounded-lg sm:rounded-xl p-2 sm:p-4 text-center">
            <div className="text-lg sm:text-2xl font-bold text-[#2563eb]">{displayStats.overall.total}</div>
