          ...
          <>
            ...
            {showAnswer && question.answer && (
              <div className="mt-4 sm:mt-6 p-3 sm:p-4 bg-[#0a0f1a] rounded-lg sm:rounded-xl border border-[#1f2937] fade-in">
                <h4 className="font-semibold mb-1.5 sm:mb-2 text-[#2563eb] text-sm sm:text-base">Answer:</h4>
                <p className="text-base sm:text-lg mb-3 sm:mb-4">{question.answer}</p>
                
                {question.explanation && question.explanation.length > 0 && (
                  <>
                    <h4 className="font-semibold mb-1.5 sm:mb-2 text-[#2563eb] mt-3 sm:mt-4 text-sm sm:text-base">Explanation:</h4>
              ...
              <div className="mt-4 sm:mt-6">
                <div className="flex gap-3">
                  <input
                    ...
                    className="flex-1 bg-[#0a0f1a] border border-[#374151] rounded-lg px-4 py-2.5 sm:py-3 text-white placeholder-[#6b7280] focus:outline-none focus:border-[#2563eb] transition-colors text-sm sm:text-base"
                  />
                </div>
              </div>
            )}
